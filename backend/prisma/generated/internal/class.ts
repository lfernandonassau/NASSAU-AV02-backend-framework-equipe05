...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Rafael\\OneDrive\\Documentos\\projetoKodan\\NASSAU-AV02-backend-framework-equipe05\\backend\\prisma\\generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Rafael\\OneDrive\\Documentos\\projetoKodan\\NASSAU-AV02-backend-framework-equipe05\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "..",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"../prisma/generated\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n\n  posts   Post[]\n  profile Profile?\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n\n  // FK -> User\n  userId Int\n  user   User @relation(fields: [userId], references: [id])\n}\n\nmodel Profile {\n  id  Int     @id @default(autoincrement())\n  bio String?\n\n  // 1:1 com User (FK única)\n  userId Int  @unique\n  user   User @relation(fields: [userId], references: [id])\n}\n",
  "inlineSchemaHash": "e24d6e5d387dc1b942b1f228c51df00abccbc389b1e69c24d4d7ffd78f455462",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
